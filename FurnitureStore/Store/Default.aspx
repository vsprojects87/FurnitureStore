<%@ Page Title="" Language="C#" MasterPageFile="~/Store/Store.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="FurnitureStore.Store.Default" %>
                ...
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1">
                            <img src="../Assets/images/img-grid-1.jpg" alt="Untree.co"></div>
                        <div class="grid grid-2">
                            <img src="../Assets/images/img-grid-2.jpg" alt="Untree.co"></div>
                        <div class="grid grid-3">
                            <img src="../Assets/images/img-grid-3.jpg" alt="Untree.co"></div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail">
                            <img src="../Assets/images/post-1.jpg" alt="Image" class="img-fluid"></a>
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail">
                            <img src="../Assets/images/post-2.jpg" alt="Image" class="img-fluid"></a>
                        <div class="post-content-entry">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail">
                            <img src="../Assets/images/post-3.jpg" alt="Image" class="img-fluid"></a>
                        <div class="post-content-entry">
